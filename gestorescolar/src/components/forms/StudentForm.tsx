...
const StudentForm = ({
  ...
  return (
    <form className="flex flex-col gap-4 h-full" onSubmit={onSubmit}>
      <h1 className="text-xl font-semibold">Agregar estudiante</h1>
      ...
      <div className="flex justify-between flex-wrap gap-4">
        ...
        <InputField
          ...
          name="telTutor"
          defaultValue={data?.telTutor}
          register={register}
          error={errors?.phone}
        />
        <InputField
          label="Correo electrónico del tutor/a"
          name="emailTutor"
          defaultValue={data?.emailTutor}
          register={register}
          error={errors?.email}
        />
      </div>
      <button className="bg-verde-400 text-white p-2 rounded-md">
